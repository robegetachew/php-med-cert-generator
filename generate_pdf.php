...
<div>
    ...
    <table cellpadding="2">
        <tr>
            <td width="60%"></td>
            <td width="40%">
                <p style="border-bottom:1px solid #000" align="center"><?= (isset($meta['doctor_fullname']) && isset($meta['doctor_suffix'])) ? $meta['doctor_fullname'] . (isset($meta['doctor_suffix']) ? ", " . $meta['doctor_suffix'] : "") : "" ?></p>
            </td>
        </tr>
        <tr>
            <td width="60%"></td>
